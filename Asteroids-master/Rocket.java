...
public class Rocket extends SmoothMover
{
    ...
    /**
     * act is the method that is run during every iteration of the act cycle
     * 
     * @param None If there is one then we've got a problem
     * @return Ditto
     * 
    ...
    /**
     * checkKeys checks to see if cutain keys are pressed. If they are cutain things will happen, such as moving the rocket, firing, and
     * sending proton wave.
     * 
    ...
    /**
     * fire sends out bullets from the rocket at a curtain speed
     * 
     * @param None There are no parameters
     * @return Nothing is returned
     * 
    ...
    /**
     * startProtonWave adds a proton wave to wherever the rocket is but if the
     * proton wave has been used recently it won't add a proton wave
     * 
     * @param None There are no parameters
     * @return Nothing is returned
     * 
    ...
    /**
     * ignite changes the rocket image to make it look like thrusters are on and speeds up the rocket movement by a bit
     * 
     * @param There are no parameters
     * @return Nothing is returned
     * 
    ...
    /**
     * checkCollision checks to see if the rocket has collided with an asteroid and removes the rocket if it has.
     * 
     * @param There are no parameters
     * @return Nothing is returned
     * 
