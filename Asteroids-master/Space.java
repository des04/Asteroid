...
public class Space extends World
{
    ...
    private final int START_ASTEROIDS = Greenfoot.getRandomNumber(9)+1;
    ...
    /**
     * paintStars puts the stars in the world (chooses their location, colour)
     * 
     * @param There are no parameters
     * @return Nothing is returned
     * 
    ...
    /**
     * addAsteroids adds new asteroid objects to the world at random places until a desired number of asteroids is reached
     * 
     * @param There is a parameter called count that represents the number of
     * asteroids that will be added to the world
     * 
     * @return Nothing is returned
     * 
