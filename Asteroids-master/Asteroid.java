...
public class Asteroid extends SmoothMover
{
    ...
    /**
     * setSize sets the size of the asteroid by scaling the image proportionally
     * 
     * @param There is a parameter called size that represents the asteroid size
     * @return Nothing is returned
     * 
    ...
    /**
     * hit calls up the breakUp method and sets the countScore method to either 15, 30, or 50 depending on the asteroids current size
     * 
     * @param There is an int parameter called dammage that represents the ammount of dammage done to the asteroid
     * @return Nothing is returned
     * 
    ...
    /**
     * breakUp allows the asteroids to break up a curtain ammount of times 
     * before removing themselves from the world
     * 
     * @param There is an int parameter called numBreakUp which represents the
     * number of times the asteroid breaks up
     * @return Nothing is returned
     * 
