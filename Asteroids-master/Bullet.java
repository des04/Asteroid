...
public class Bullet extends SmoothMover
{
    ...
    /**
     * checkAsteroidHit checks to see if the bullet hit  an asteroid and adds dammage to the asteroids "health". It also removes the
     * asteroid from the world if the asteroid has no "health" left.
     * 
     * @param None There are no parameters
     * @return Nothing is returned
     * 
